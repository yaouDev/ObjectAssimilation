...
public class GifMaker
{
    ...
    public void ImageInfo(List<Bitmap> Bitmaps, int id)
    {
        ...
        var frameDelayBytes = BitConverter.GetBytes((uint)4);
        ...
        using (var stream = new FileStream(id + "_animation.gif", FileMode.Create))
        {
            bool first = true;
